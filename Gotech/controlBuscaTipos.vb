Public Class controlBuscaTipos
    ...
    Sub llenaLista()
        ...
        Rc = DatosGotech.OLEDB.tipos_retornaTodo()
    ...
    Sub llenaLista(ByVal criterio As String)
        ...
        Rc = DatosGotech.OLEDB.tipos_retornaTodo_LIKE(criterio)
    ...
    Sub seleccionaContacto()
        If ListView1.SelectedItems.Count >= 1 Then
            Buffer.tipoCodigo = CInt(ListView1.SelectedItems(0).Text)
            Buffer.tipoNombre = ListView1.SelectedItems(0).SubItems(1).Text
